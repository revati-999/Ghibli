...
var toggs = document.querySelector('.navbar-brand');
var togg_button = document.getElementById('togg-butt');
var close_btn = document.getElementById('closeBtn'); // const toggler = document.getElementsByClassName('.navbar-toggler');

var navbarCollapse = document.querySelector('.navbar-collapse');
togg_button.addEventListener('click', function () {
